...
class nervana::image_blob : public provider_interface
{
public:
    image_blob(nlohmann::json js);
    void provide(int idx, buffer_in_array& in_buf, buffer_out_array& out_buf);

private:
    image::config               image_config;
    blob::config                blob_config;
    ...
    blob::extractor             blob_extractor;
    blob::loader                blob_loader;
};
