...
class nervana::block_loader_source_async
    : public async_manager<std::vector<std::vector<std::string>>, variable_buffer_array>
{
public:
    block_loader_source_async(async_manager_source<std::vector<std::vector<std::string>>>* source)
        : async_manager<std::vector<std::vector<std::string>>, variable_buffer_array>(source)
    {
